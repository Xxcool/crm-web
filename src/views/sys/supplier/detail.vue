        ...
        <el-table
          ...
          <el-table-column label="操作" width="300">
            <template slot-scope="scope">
              ...
              <el-button v-has="'supplier:supplier:edit'" type="primary" @click="handelContactUpdate(scope)" :disabled="checkList.indexOf(scope.row.addUserId)==-1">编辑
              </el-button>
              <el-button v-has="'supplier:supplier:del'" type="danger" @click="handleContactDel(scope.row)" :disabled="checkList.indexOf(scope.row.addUserId)==-1">删除
              </el-button>
            </template>
          </el-table-column>
        </el-table>
